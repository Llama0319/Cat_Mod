...
public class CatTowerPlatform extends BaseHorizontalBlock{
	
	private static final VoxelShape SHAPE = Stream.of(
			Block.makeCuboidShape(2, 0, 2, 14, 1, 14),
			Block.makeCuboidShape(6, 1, 6, 10, 13, 10),
			Block.makeCuboidShape(1, 13, 5, 2, 14, 11),
			Block.makeCuboidShape(14, 13, 5, 15, 14, 11),
			Block.makeCuboidShape(5, 13, 1, 11, 14, 2),
			Block.makeCuboidShape(5, 13, 14, 11, 14, 15),
	...
	public CatTowerPlatform(Properties properties) {
		super(properties);
