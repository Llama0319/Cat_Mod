...
import com.llama0319.catmod.common.containers.ItemPedestalContainer;
...
public class ItemPedestalTileEntity extends LockableLootTileEntity implements IClearable, INamedContainerProvider {
	...
	public ItemPedestalTileEntity() {
		this(TileEntityTypeInit.ITEM_PEDESTAL.get());
	}
	...
	protected ITextComponent getDefaultName() {
		return new TranslationTextComponent("container." + Cat_Mod.MOD_ID + ".item_pedestal");
	}
