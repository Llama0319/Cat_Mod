...
public class ExampleEntity extends AnimalEntity {
	...
	public AgeableEntity createChild(AgeableEntity ageable) {
		...
		entity.onInitialSpawn((IServerWorld) this.world, this.world.getDifficultyForLocation(new BlockPos(entity)),
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.ACORN.get()), false));
	...
	public void registerAttributes() {
		...
		this.createMutableAttribute(Attributes.MAX_HEALTH, 50.0D);
		this.createMutableAttribute(Attributes.MOVEMENT_SPEED, 5f);
		this.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 100f);
	}

	private void createMutableAttribute(Attribute maxHealth, double d) {
