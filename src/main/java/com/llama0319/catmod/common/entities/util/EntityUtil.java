package com.llama0319.catmod.common.entities.util;
...
public class EntityUtil {
	...
	public static ILivingEntityData childChance(AgeableEntity e, SpawnReason reason, ILivingEntityData livingdata,
			float chance) {
		if (livingdata != null && livingdata instanceof AgeableData) {
			try {
				Field babySpawnProbability = ObfuscationReflectionHelper.findField(AgeableData.class,
						"field_226256_c_");
